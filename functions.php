...
function artezpress_style()
{
	...
	wp_register_style('flickity-theme-css', 'https://unpkg.com/flickity@2/dist/flickity.min.css');
	...
	wp_enqueue_style('flickity-theme-css');
...
function ap_author_custom_post_type() {
	...
	$args = array(
		"label" 				=> esc_html__( "authors", "artezpress" ),
		'labels'                => $labels,
		'hierarchical'          => false,
		'public'                => true,
		'show_ui'               => true,
