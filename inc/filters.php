...
<div class="search-bar">
        ...
        <div class="filter-item js-filter-collapse">Tags</div>
        <div class="filter-item js-filter-collapse active">Category</div>
        <div class="filter-item js-filter-collapse">Year</div>
        <div class="filter-item js-filter-collapse">Language</div>
