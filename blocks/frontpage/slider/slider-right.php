...
<div class="carousel-container backlist">
  <div class="highlights-carousel backlist-carousel">
    ...
    if ($loop->have_posts()) :
        ...
        <div class="carousel-cell carousel-cell-highlights carousel-cell__backlist" style="background-color: <?php echo $single_product_bg;?>" data-color="<?= $single_product_text_color; ?>"  data-url="<?php the_permalink(); ?>">
