			...
			<?php if (!is_product()) : ?>
				<div class="logo js-toggle-menu">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 160 24">
						<path d="M5.92,19.42a5.79,5.79,0,0,1-1.49-.17c-.55-.19-.83-.49-.83-.9A5.86,5.86,0,0,1,4,16.73c.12-.35.4-1.1.82-2.25h6.52l.73,1.75q.24.59.39,1a3.64,3.64,0,0,1,.22,1c0,.5-.14.81-.44.93a6.85,6.85,0,0,1-1.86.24v.73h9.39v-.73a1.72,1.72,0,0,1-1.53-.71,20.07,20.07,0,0,1-1.63-3.29L10.11.25h-.8L2.86,16.05a13.2,13.2,0,0,1-1.17,2.42,2.19,2.19,0,0,1-1.69,1v.73H5.92ZM7.86,6.66H8.1l2.79,6.68H5.24Z" />
						<path d="M29.14,19.46A3.1,3.1,0,0,1,27.47,19c-.28-.24-.42-.83-.42-1.78V11.74a3.14,3.14,0,0,1,.59-2A1.6,1.6,0,0,1,28.81,9c.18,0,.5.28,1,.86a2,2,0,0,0,1.59.86,1.74,1.74,0,0,0,1.32-.55,2,2,0,0,0,.5-1.4,2,2,0,0,0-.72-1.67,2.5,2.5,0,0,0-1.61-.57,3.35,3.35,0,0,0-2.1.71,10.8,10.8,0,0,0-1.83,1.9V6.86h-5.5v.69A2.12,2.12,0,0,1,22.65,8,1.87,1.87,0,0,1,23,9.23v7.85l0,.85a1.65,1.65,0,0,1-.35,1.14,2.18,2.18,0,0,1-1.17.39v.69h7.73Z" />
						<path d="M36.06,17.49a2.71,2.71,0,0,0,1.47,2.66,3.9,3.9,0,0,0,1.79.38,4,4,0,0,0,3-1.31,6.59,6.59,0,0,0,1.22-1.93l-.7-.34a5.32,5.32,0,0,1-.76,1.11,1.25,1.25,0,0,1-.95.4,1,1,0,0,1-.94-.63,2.55,2.55,0,0,1-.18-1V8.13h2.76V6.86H40.05V2h-.74a23.15,23.15,0,0,1-2.39,3.09c-.45.49-.92,1-1.42,1.42s-.69.6-1,.84v.8h1.51Z" />
						<path d="M62.64,14.15h-.81a8.9,8.9,0,0,1-3.12,4,8.53,8.53,0,0,1-4.53,1.08,3.71,3.71,0,0,1-2-.34,1.4,1.4,0,0,1-.47-1.24v-7a4.65,4.65,0,0,1,3.43,1,6.21,6.21,0,0,1,1.27,3.48h.74V5.39h-.74a6.84,6.84,0,0,1-1.35,3.38c-.58.62-1.7.91-3.35.9V3a1.32,1.32,0,0,1,.36-1.09,3.29,3.29,0,0,1,1.69-.27c2.33,0,3.94.34,4.82,1a6.15,6.15,0,0,1,1.88,3.82h.71V.64H44.5v.74a4.52,4.52,0,0,1,1.75.33,1.75,1.75,0,0,1,.83,1.7v14a1.77,1.77,0,0,1-.8,1.69,4.13,4.13,0,0,1-1.78.34v.73h17Z" />
						<path d="M81.94,13.2h-.76Q80.07,17.36,78,18.25t-8.11.9l11.22-18V.64H65.67l-.61,6h.81a13,13,0,0,1,1.44-3,4.79,4.79,0,0,1,3-1.75c.36-.07.75-.13,1.18-.17s1.76-.07,4-.07L64.15,19.69v.46h17Z" />
						...
						<rect y="22.6" width="82.3" height="1.16" />
						<rect x="92.94" y="22.6" width="67.06" height="1.16" />
					</svg>
				</div>
			<?php endif; ?>
			<?php if (is_product()) : ?>
				<div class="block-price price">
					...
					<?php
					// prijs pill voor related editions
					$rows = get_field('additional_editions', $the_product_ID);
					// var_dump($rows);
					if (have_rows('additional_editions')) : while (have_rows('additional_editions')) : the_row();
							...
							$related_book 	= get_sub_field('related_edition');
							if ($related_book) :
